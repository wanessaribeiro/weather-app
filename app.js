...
const APP_ID = 'ac4888467afc121d832dac96d3ca56d0'
...
function searchWeather() {
  ...
  const URL = 'http://https://api.openweathermap.org/data/2.5/weather?q=' + CITY_NAME + '&units=metric&appid=' + APP_ID
  ...
  Http.fetchData(URL).then(responseData => {
    ...
    WEATHER_PROXY.temperature = responseData.main[0].temp;
